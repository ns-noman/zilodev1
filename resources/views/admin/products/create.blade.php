                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="col-6">
                                                        <img id="product_image_back_view" style="width:100px!imporatant; height:100px!imporatant;" class="img-thumbnail" src="{{ asset('public/uploads/admin/placeholder.png') }}">
